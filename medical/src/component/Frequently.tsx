                        ...
                        <div className="col-xxl-7 col-xl-6 col-lg-5 m-b30 align-self-center">
                            <div className="content-info">
                                <div className="section-head style-1 m-b30">
                                    ...
                                    <p className="wow fadeInUp" data-wow-delay="0.4s" data-wow-duration="0.7s">Find quick answers about appointments, services, insurance, and visiting AMC.</p>
                                </div>
                                <Accordion className="accordion dz-accordion style-1" defaultActiveKey="0">
                                    {accordiondata.map((data, i) => (
                                        <Accordion.Item eventKey={data.key} key={i} className="wow fadeInUp" data-wow-delay={data.delay} data-wow-duration="0.7s">
                                            ...
                                            <Accordion.Body>
                                                {(data as any).answer || 'It is a long established fact that a reader will be distracted by the readable content of a page when looking at its. The point of using Lorem Ipsum is that it has a more-or-less normal distribution'}
                                            </Accordion.Body>
                                        </Accordion.Item>
                                    ))}
                                </Accordion>
                        ...
                        <div className="col-xxl-5 col-xl-6 col-lg-7 m-b30">
                            <div className="content-media" data-bottom-top="transform: translateY(50px)" data-top-bottom="transform: translateY(-50px)">
                                ...
                                <div className="item1">
                                    ...
                                    <Link href="#" className="btn btn-lg btn-icon btn-primary btn-shadow">
