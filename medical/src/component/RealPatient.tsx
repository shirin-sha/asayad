                ...
                <div className="row content-wrapper style-2">
                    ...
                    <div className="col-xl-6 col-lg-10 align-self-center m-b30">
                        <div className="section-head style-1 m-b30 wow fadeInUp" data-wow-delay="0.2s" data-wow-duration="0.7s">
                            <h2 className="title text-white m-b0" style={{ fontSize: '36px' }}>Real Patients, Real Stories. <br /> And Our Commitment To Better Care</h2>
                        </div>
                                        ...
                                        <div className="testimonial-1 shadow-md">
                                            ...
                                            <div className="testimonial-detail">
                                                <div className="testimonial-text">
                                                    <h3 className="title">{(data as any).title || 'Best Treatment'}</h3>
                                                    <p>{(data as any).description || 'It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using \'Content here, content here\', making it look like readable'}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </SwiperSlide>
