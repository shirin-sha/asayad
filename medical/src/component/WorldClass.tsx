            ...
            <div className="row content-wrapper style-1 align-items-center">
                ...
                <div className="col-xl-6 m-b30">
                    <div className="section-head style-1 m-b30">
                        <h2 className="title wow fadeInUp" data-wow-delay="0.2s" data-wow-duration="0.8s">World-Class Patient Facilities Designed For You</h2>
                        <p className="wow fadeInUp" data-wow-delay="0.4s" data-wow-duration="0.8s">At Asayad Medical Center (AMC), we combine modern medical technology with experienced specialists to deliver safe, accurate, and comfortable care. From consultation to diagnosis and treatment, our facility is designed to make every visit smooth, private, and patient-friendly—so you can focus on getting better with confidence.</p>
                    </div>
                    ...
                    <div className="d-flex flex-wrap align-items-center wow fadeInUp" data-wow-delay="0.8s" data-wow-duration="0.8s">
                        ...
                        <div className="info-widget style-5">
                            ...
                            <div className="widget-content">
                                ...
                                <Link href="tel:+96522211900" className="text-secondary">+965 22211900</Link>
                            </div>
                        </div>
                    </div>
                </div>
