            ...
            <div className="row content-wrapper style-7 align-items-center">
                    ...
                    <div className="content-media">
                        ...
                        <div className="item1">
                            <div className="info-widget style-11 bg-primary text-center">
                                ...
                                <h3 className="title m-b0 text-white">Years of <br /> Trusted Care</h3>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="col-lg-6 m-b30">
                    <div className="section-head style-1 m-b30">
                        <h2 className="title text-white m-b0 wow fadeInUp" data-wow-delay="0.2s" data-wow-duration="0.7s" style={{ fontSize: '36px' }}>Why Choose Asayad Medical Center For Your Health Care Needs</h2>
                    </div>
                            ...
                            <div className="col-sm-6" key={i}>
                                <div className="icon-bx-wraper style-4 text-center text-white wow fadeInUp" data-wow-delay={data.delay} data-wow-duration="0.7s">
                                    ...
                                    <div className="icon-content">
                                        ...
                                        <p>{(data as any).description || 'We offer a wide range of health services to meet all your needs.'}</p>
                                    </div>
                                </div>
                            </div>
                        ))}
